...
@section('titre')
   ...
   Rainbow-business modifier_slider
              ...
              <form  action="{{url('/admin/updateslider/'.$slider->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" value="{{$slider->description2}}" name="description2" class="form-control" id="exampleInputEmail1" required>
                  </div>
                ...
                <div class="card-footer">
                  ...
                  <input type="submit" class="btn btn-warning" value="Modifierr" >
                </div>
              </form>
            </div>
            <!-- /.card -->

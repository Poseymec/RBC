      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-all duration-300">
          <div class="mb-4 text-[#E8192C]">
            <!-- mdi:earth -->
            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24">
              <path fill="currentColor" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10s10-4.48 10-10S17.52 2 12 2m0 18c-1.85 0-3.55-.46-5-1.27l1.36-1.36c1.14.62 2.46.93 3.64.93s2.5-.31 3.64-.93l1.36 1.36c-1.45.81-3.15 1.27-5 1.27m0-3c-1.66 0-3-1.34-3-3s1.34-3 3-3s3 1.34 3 3s-1.34 3-3 3m0-4c-.55 0-1 .45-1 1s.45 1 1 1s1-.45 1-1s-.45-1-1-1z"/>
            </svg>
          </div>
          <h3 class="text-2xl font-bold mb-2 text-[#E8192C]">
            Qualité garantie
